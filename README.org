* Key Light Control
This repository includes several scripts to control Elgato Key Light conected lights. They are written in Python and use the module [[https://pypi.org/project/leglight/][leglight]].
